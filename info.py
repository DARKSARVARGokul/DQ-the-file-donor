...
PICS = (environ.get('PICS', 'https://graph.org/file/de6773febcac8d3847411.jpg')).split()
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/de6773febcac8d3847411.jpg")
...
auth_channel = environ.get('-1002213129805')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('-1002247963596')
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://G:G@cluster0.wzac1di.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
